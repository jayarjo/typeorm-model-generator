...
describe("Model customization phase", async () => {
    ...
    describe("case-file", () => {
        it("PascalCase", () => {
            ...
            const customizedModel = ModelCustomization_1.default(data, generationOptions, {});
            ModelGeneration_1.default(IConnectionOptions_1.getDefaultConnectionOptions(), generationOptions, customizedModel);
            ...
            runTestsFromPath_test_1.compileGeneratedModel(generationOptions.resultsPath, [""]);
        });
        it("camelCase", () => {
            const data = generateSampleData();
            const generationOptions = generateGenerationOptions();
    ...
    describe("case-entity", () => {
        ...
        it("camelCase", () => {
            ...
            expect(postContent).to.contain("class post {");
            expect(postAuthorContent).to.contain("class postAuthor {");
            runTestsFromPath_test_1.compileGeneratedModel(generationOptions.resultsPath, [""], false);
        });
    });
